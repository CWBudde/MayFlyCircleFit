...
| `internal/opt` | Optimizer interface, MayFly v0.6.0 adapter, and a proof-of-concept Dragonfly v0.1.0 adapter, selected by `JobConfig.optimizer` | Rendering semantics |
